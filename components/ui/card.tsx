...
function Card({
  ...
  size?: "default" | "sm"
  /** Lift + deepen shadow on hover — on by default per the design system. */
  hover?: boolean
}) {
  return (
    <div
      ...
      className={cn(
        ...
        hover &&
          "transition-[transform,box-shadow] duration-200 ease-in-out hover:-translate-y-0.5 hover:shadow-lg",
        className
      )}
      {...props}
    />
